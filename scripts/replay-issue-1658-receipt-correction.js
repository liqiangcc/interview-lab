...
const rows = snapshot.rows.map(row => {
  ...
  const generic=planMaterialization(request,{repository:'liqiangcc/interview-lab',sourceIssue:row.source,issues:options.ownerIssues,receipts});
