...
scope digest `6ef4fa26e838fe8c30d571c08807c09d5a3280eb40aa4af57d679274f6a131a1`、当前 plan
digest、正整数 `max_mutations`、`authorized_by` 和 `proof_sha256`。proof 的 comment_id 必须
