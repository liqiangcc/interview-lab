...
- Results: 229 `single-interview`, 3 `multi-interview`, 12 `not-interview`, and 93 blocked
...
records of the no-apply run. `boundary-batch.json` lists only the 244 decided
