...
- Results: 233 `single-interview`, 3 `multi-interview`, 54 `not-interview`, and 47 blocked
...
records of the no-apply run. `boundary-batch.json` lists only the 290 decided
